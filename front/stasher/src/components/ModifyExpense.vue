        ...
        methods: {
            ...
            if (this.checkForm()){
                ...
                .then(function (response) {
                    ...
                    currentObj.message = "Expense updated successfully";
    ...
    <div class="flex-wrap w-3/4 mx-auto py-2 my-5">
        ...
        <FormInput label="Id" :readonly="true" placeholder="Id of expense..." name="id" v-model="id" :value="expenseId.toString()" type="Number" error="Incorrect id"></FormInput>
        <FormInput label="Amount" placeholder="Amount of expense..." name="amount" v-model="amount" :value="expenseAmount.toString()" type="Number" error="Incorrect amount"></FormInput>
        <FormInput label="Description" placeholder="Description of expense..." name="description" v-model="description" :value="expenseDescription" type="text" error="Incorrect description"></FormInput>
        <FormInput label="Produced date" placeholder="Produced date of expense..." name="producedDate" v-model="producedDate" :value="new Date().toISOString().slice(0, 10)" type="text" error="Incorrect produced date"></FormInput>
        ...
        <input label="send" name="send" value="Modify Expense" type="submit" class=" bg-stone-200 hover:bg-stone-400 hover:text-stone-200 text-rose-900 font-bold py-2 px-4 inline-block mt-6 rounded w-full"
        />
